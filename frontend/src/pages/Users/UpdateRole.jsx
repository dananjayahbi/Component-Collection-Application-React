  ...
  const handleSubSelectionChange = (event, sub, isChecked) => {
    ...
    setSelectedSubs((prevSelectedSubs) => {
      if (isChecked) {
        ...
        return prevSelectedSubs.filter(
          (selected) => selected.page !== selectedSub
        );
      }
    });
  };
                            ...
                            control={
                              <Checkbox
                                checked={selectedSubs.some(
                                  (sub) =>
                                    main.subs.includes(sub.page) && sub.access
                                )}
                                onChange={(e) => {
                                  ...
                                  if (isChecked) {
                                    ...
                                    setSelectedSubs((prevSelectedSubs) =>
                                      prevSelectedSubs.filter(
                                        (sub) => !main.subs.includes(sub.page)
                                      )
                                    );
                                  }
                                }}
